...
![LPI rollout by year](f1_rollout.png)
...
![Mechanism split](f3_mechanism.png)
...
![Event study](f2_event_study.png)
...
![Specifications](f4_specifications.png)
...
![Spatial diagnostics](f7_spatial.png)
...
listed above; code available on request. Result tables are included as CSVs, with column definitions in DATA_DICTIONARY.md.
